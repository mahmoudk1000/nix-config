...
stdenv.mkDerivation {
  ...
  wslviewScript = ''
    ...
    # Version
    wslu_version=4.1.4-1
    wslu_prefix=""
    wslu_dest_dir="/nix/store/0nfjhf9kkm4jn71isx4mryby3slpswnj-wslu-4.1.4"
    ...
    if [ -f "/nix/store/0nfjhf9kkm4jn71isx4mryby3slpswnj-wslu-4.1.4/share/wslu/conf" ]; then
    	debug_echo "/nix/store/0nfjhf9kkm4jn71isx4mryby3slpswnj-wslu-4.1.4/share/wslu/conf found, sourcing"
    	source "/nix/store/0nfjhf9kkm4jn71isx4mryby3slpswnj-wslu-4.1.4/share/wslu/conf"
    fi
  ...
  installPhase = ''
    ...
    cp $wslviewScriptPath $out/bin/wslview

    ...
    pipewire-pulse."92-low-latency" = {
      context.modules = [
        ...
        }
        {
          ...
          args = {
            pulse.min.req = "${toString cfg.quantum.min}/${toString cfg.rate}";
            pulse.default.req = "${toString cfg.quantum.min}/${toString cfg.rate}";
            pulse.max.req = "${toString cfg.quantum.min}/${toString cfg.rate}";
            pulse.min.quantum = "${toString cfg.quantum.min}/${toString cfg.rate}";
            pulse.max.quantum = "${toString cfg.quantum.min}/${toString cfg.rate}";

...
let s:light_green     = { "gui": "#DAFBDF" }
let s:yellow          = { "gui": "#FFF1AC" }
let s:light_yellow    = { "gui": "#FFFBB6" }
let s:blue            = { "gui": "#90A8BE" }
let s:light_blue      = { "gui": "#9AB2C8" }
let s:purple          = { "gui": "#D7C8F3" }
...
call s:Color('Identifier', {'fg': s:blue, 'gui': 'italic'})
call s:Color('Keyword', {'fg': s:foreground})
...
call s:Color('WarningMsg', {'fg': s:purple})
...
"" Bufferline
call s:Color('BufferLineIndicatorSelected', {'fg': s:darker})
call s:Color('BufferLineFill', {'bg': s:darker})
call s:Color('BufferTabpageFill', {'bg': s:darker})
call s:Color('BufferLineSeparator', {'fg': s:light_black})
call s:Color('BufferInactive', {'fg': s:light_black})

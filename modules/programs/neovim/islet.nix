...
in
{
  home.file.".config/nvim/colors/${name}.lua".text = ''
    ...
    highlight("Operator", { fg = c.norm })
    highlight("Delimiter", { fg = c.norm })
    ...
    highlight("@keyword.operator", { link = "Keyword" })
    ...
    highlight("@constructor", { fg = c.white })
    ...
    highlight("@function.builtin", { fg = c.purple })
    highlight("@function.call", { fg = c.purple })
    highlight("@function.macro", { link = "@keyword" })
    highlight("@function.method", { fg = c.white })
    highlight("@function.method.call", { fg = c.blue })
    ...
    highlight("@string.escape", { fg = c.yellow, bold = true })
    highlight("@string.regexp", { fg = c.bright_yellow })
    ...
    highlight("@tag.delimiter", { fg = c.norm })
    highlight("@tag.attribute", { fg = c.blue })
    ...
    highlight("@method", { fg = c.white })
    highlight("@method.call", { fg = c.purple })

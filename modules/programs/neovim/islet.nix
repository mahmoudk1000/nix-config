...
in
{
  home.file.".config/nvim/colors/${name}.lua".text = ''
    ...
    highlight("Function", { fg = c.base06 })
    highlight("Identifier", { fg = c.base05 })
    highlight("Include", { fg = c.base0E })
    highlight("Keyword", { fg = c.base0F, bold = true })
    ...
    highlight("@method.call", { fg = c.base07, italic = true })

    highlight("@keyword", { link = "Keyword" })
    highlight("@keyword.function", { fg = c.base05 })
    highlight("@keyword.return", { fg = c.base0C, bold = true })

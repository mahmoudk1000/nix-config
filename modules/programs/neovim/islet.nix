...
in
{
  home.file.".config/nvim/colors/${name}.lua".text = ''
    ...
    highlight("BufferLineCloseButtonSelected", { fg = c.red, bg = c.light_black })
    highlight("BufferLineBackground", { fg = c.subtle, bg = c.light_black })
    highlight("BufferLineBufferVisible", { fg = c.fg, bg = c.light_black })
    highlight("BufferLineDuplicate", { fg = c.subtle, bg = c.light_black })
    highlight("BufferLineDuplicateVisible", { fg = c.subtle, bg = c.light_black })
    highlight("BufferLineBufferSelected", { fg = c.norm, bg = c.bg, bold = true })
    highlight("BufferLineDuplicateSelected", { fg = c.norm, bg = c.bg, bold = true })
    ...
    highlight("BufferLineNumbers", { fg = c.subtle, bg = "NONE" })
    highlight("BufferLineNumbersSelected", { fg = c.yellow, bg = "NONE", bold = true })
    highlight("BufferLineNumbersVisible", { fg = c.subtle, bg = "NONE" })

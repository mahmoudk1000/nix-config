...
in
{
  home.file.".config/nvim/colors/${name}.lua".text = ''
    ...
    highlight("@keyword.function", { fg = c.red })
    highlight("@keyword.return", { fg = c.red })
    highlight("@keyword.operator", { fg = c.red })
    ...
    highlight("@string.escape", { fg = c.blue, bold = true })

...
in
{
  home.file.".config/nvim/colors/${name}.lua".text = ''
    ...
    -- __COMMENT__
    highlight("Todo", { fg = c.yellow, bg = c.black, bold = true })
    ...
    highlight("@attribute", { link = "PreProc" })
    ...
    highlight("@string.regexp", { link = "String" })
    ...
    highlight("@tag.attribute", { link = "Tag" })
    ...
    highlight("@variable.parameter.reference", { link = "Variable" })
    highlight("@field", { fg = c.cyan })
    highlight("@method", { fg = c.white, bold = true })
    highlight("@method.call", { fg = c.white, bold = true })
    highlight("@namespace", { fg = c.blue })
    highlight("@parameter", { fg = c.norm, italic = true })

...
''
  {
    "name": "Mont",
      ...
      "colors": {
        ...
        "editor.foreground": "${base0F}",
        "activityBarBadge.background": "${base06}",
        "sideBarTitle.foreground": "${base0F}",
        ...
        "progressBar.background": "${base0F}",
        "textLink.foreground": "${base0F}",
        "pickerGroup.foreground": "${base0F}",
        "editorOverviewRuler.findMatchForeground": "${base0F}",
        "editor.findMatchBorder": "${base0F}",
        "tab.activeBorder": "${base0F}",
        "statusBarItem.remoteBackground": "${base0F}",
        "activityBarBadge.background": "${base0F}",
        "list.activeSelectionForeground": "${base0F}",
        "list.inactiveSelectionForeground": "${base0F}",
        "list.highlightForeground": "${base0F}",
        "scrollbarSlider.activeBackground": "${base0F}",
        "editorSuggestWidget.highlightForeground": "${base0F}",
        "editorWidget.resizeBorder": "${base0F}",
        "panelTitle.activeBorder": "${base0F}",
        "notificationLink.foreground": "${base0F}",
        "breadcrumb.activeSelectionForeground": "${base0F}",
        "menu.selectionForeground": "${base0F}",
        "menubar.selectionForeground": "${base0F}",
        "settings.headerForeground": "${base0F}",
        "settings.modifiedItemIndicator": "${base0F}",
        ...
        "editorHoverWidget.border": "${base0F + "10"}",
        ...
        "terminal.ansiBrightWhite": "${base0F}",
        ...
        "editorSuggestWidget.border": "${base0F + "10"}",
        "panelTitle.activeForeground": "${base0F}",
